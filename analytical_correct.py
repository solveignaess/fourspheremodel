...
# plt.contourf(theta.reshape(180,180), phi_angle.reshape(180,180), phi_20.reshape(180,180), cmap='PRGn')
# plt.figure()
# fem_vals = np.load('./results/FEM_results_rad.npz')
# phi_fem = fem_vals['FEM_20']
# plt.contourf(theta.reshape(180,180), phi_angle.reshape(180,180), phi_fem.reshape(180,180), cmap='PRGn')

# #plt.plot(th, phi_old, 'r')
# #plt.plot(th, phi, 'b.')
# plt.show()
