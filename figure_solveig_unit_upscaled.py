...
ax4.set_title('Difference', y = 1.1)
...
print 'saving figure'
# fig.tight_layout()
plt.savefig('./results/eeg_fig_scaled3.png', dpi=600., bbox_inches='tight')
