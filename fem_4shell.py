...
if __name__ == '__main__':
    ...
    main_4shell_fem(mesh, subdomains, boundaries, params.sigma_skull20, '4Shell_FEM_20.npy')
    print 'Done 4Shell-FEM-20'
    main_4shell_fem(mesh, subdomains, boundaries, params.sigma_skull40, '4Shell_FEM_40.npy')
    print 'Done 4Shell-FEM-40'
    main_4shell_fem(mesh, subdomains, boundaries, params.sigma_skull80, '4Shell_FEM_80.npy')
